...
const Register = () => {
  ...
  return (
    <form
      ...
      className="flex h-full w-full flex-col items-center  justify-center gap-3 bg-C_WhiteGray text-lg md:h-[50%] md:w-[60%] md:gap-3 md:rounded-xl md:shadow-xl  lg:h-[70%] lg:w-[30%] "
    >
